...
def top_movies_page(request):
    ...
    return render(request,"./movie/top-movies.html",context)
...
def all_movies_page(request):
    ...
    return render(request,"./movie/all-movies.html",context)
...
def movies_by_genre_page(request,slug):
    ...
    return render(request,"./movie/movies-by-genre.html",context)
...
def movies_by_search_page(request):
    ...
    return render(request,"./movie/movies-by-search.html", context)
